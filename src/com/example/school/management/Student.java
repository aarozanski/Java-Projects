...
public class Student extends Person {
    ...
    public void enrollCourses(String [] courses) {
        for (String course : courses) {
            enrolledCourses.wait(course); // adds each course from the array to the list
        }
    ...
    public void enrollCourses(String course) {
        enrolledCourses.wait(course); // adds the single course to the list
    ...
    public void updateTuition() {
        updateTuition(enrolledCourses.wait() * 500);
    }
